...
<main id="main" class="main">
    <!-- Page Title -->
    <div class="pagetitle">
        <h1>Edit Pengajuan Ganti Rugi</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
            <li class="breadcrumb-item"><a href="datapengaduan">Pengajuan Ganti Rugi</a></li>
            <li class="breadcrumb-item">Edit Pengajuan Ganti Rugi</li>
          </ol>
        </nav>
    </div>
      <!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body">
                    <form class="row g-3 form-gantiRugi" action="../insertEditGantiRugi" method="post">
                      @csrf
                          <input type="hidden" name="id" value="{{ $data[0]->id }}">
                          <div class="form-section row mt-3">
                            <div class="col-3">
                              <label for="kantor_pos" class="form-label">Kantor Pos</label>
                              <input type="text" class="form-control" name="kantor_pos" value="{{ $data[0]->kantor_pos }}" >
                            </div>

                            <div class="col-4">
                              <label for="tanggal_surat" class="form-label">Tanggal Surat</label>
                              <input type="date" class="form-control" name="tanggal_surat"  value="{{ $data[0]->tanggal_surat }}" >
                            </div>
                            ...
                            <div class="col-5">
                              ...
                              <div class="input-group">
                                ...
                                @endphp
                                <input type="text" class="form-control" name="id_surat_1" value="{{ $arr_nomorSurat[0]  }}">
                                <span class="input-group-text">/</span>
                                <select class="form-select" id="id_surat_2" name="id_surat_2">
                                  <option value="" selected>Pilih Jenis Surat</option>
                                  @foreach ($jenisSurat as $js)
                                    <option value="{{ $js->jenis_surat }}"
                                      @if ($js->jenis_surat == $arr_nomorSurat[1] )
                                        {{'selected'}}
                                      @endif
                                      >{{ $js->jenis_surat }}</option> 
                                  @endforeach
                                </select>
                                <span class="input-group-text">/</span>
                            ...
                            <div class="col-4">
                                ...
                                <input type="telp" class="form-control" name="hp_Pelanggan" value="{{ $data[0]->nomor_hp_pelanggan }}">
                            </div>

                            <div class="col-5">
                              <label for="alamat_pelanggan" class="form-label">Alamat Pelanggan</label>
                              <textarea class="form-control" style="height: 10px" name="alamat_pelanggan">{{ $data[0]->alamat_pelanggan }}</textarea>
                            </div>
                              ...
                              <div class="col-lg-6">
                                <div class="row">
                                  <div class="col-6">
                                    ...
                                    <input type="telp" class="form-control" name="nomor_resi" value="{{ $data[0]->nomor_resi }}">
                                  </div>
                                  <div class="col-6">
                                    <label for="tanggal_kirim" class="form-label">Tanggal Kirim</label>
                                    <input type="date" class="form-control" name="tanggal_kirim" value="{{ $data[0]->tanggal_kirim }}">
                                  </div>

                                  <div class="col-6">
                                    <label for="kantor_asal_kiriman" class="form-label">Kantor Asal Kiriman</label>
                                    <input type="telp" class="form-control" name="kantor_asal_kiriman" value="{{ $data[0]->kantor_asal_kiriman }}">
                                  </div>
                                  <div class="col-6">
                                    <label for="berat" class="form-label">Berat Barang</label>
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control" name="berat" value="{{ $data[0]->berat_barang }}">
                                      <span class="input-group-text">Kg</span>
                                    </div>
                                  </div>
                                  <div class="col-12 mb-3">
                                    <label for="biaya_kirim" class="form-label">Biaya Kirim</label>
                                    <input type="text" class="form-control" name="biaya_kirim" value="{{ "Rp " . number_format($data[0]->biaya_kirim, 2, ",", ".") }}">
                                  </div>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="row">
                                  <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="nilai_barang" value="{{ "Rp " . number_format($data[0]->nilai_barang, 2, ",", ".")}}">
                                  </div>
                                  <div class="col-6">
                                    <label for="nilai_jaminan_gr" class="form-label">Nilai Jaminan Ganti Rugi</label>
                                    <input type="text" class="form-control" name="nilai_jaminan_gr" value="{{ "Rp " . number_format($data[0]->nilai_ganti_rugi, 2, ",", ".") }}">
                                  </div>
                                  <div class="col-12">
                              ...
                              <div class="col-lg-6 border">
                                <div class="row">
                                  <div class="col-6">
                                    ...
                                    <input type="telp" class="form-control" name="nama_pengirim" value="{{ $data[0]->nama_pengirim }}">
                                  </div>
                                  <div class="col-6">
                                    <label for="email_pengirim" class="form-label">Email Pengirim</label>
                                    <input type="email" class="form-control" name="email_pengirim" value="{{ $data[0]->email_pengirim }}">
                                  </div>

                                  <div class="col-6">
                                    <label for="nomor_hp_pengirim" class="form-label">Nomor HP Pengirim</label>
                                    <input type="telp" class="form-control" name="nomor_hp_pengirim" value="{{ $data[0]->nomor_hp_pengirim }}">
                                  </div>
                                  <div class="col-6">
                                      <label for="kode_pos_pengirim" class="form-label">Kode Pos Pengirim</label>
                                      <input type="telp" class="form-control" name="kode_pos_pengirim" value="{{ $data[0]->kode_pos_pengirim }}">
                                  </div>
                                  <div class="col-12">
                                    <label for="alamat_pengirim" class="form-label">Alamat Pengirim</label>
                                    <textarea class="form-control mb-2" style="height: 80px" name="alamat_pengirim">{{ $data[0]->alamat_pengirim }}</textarea>
                                  </div>
                                </div>
                              </div>
                              <div class="col-lg-6 border">
                                <div class="row">
                                  <div class="col-6">
                                    ...
                                    <input type="telp" class="form-control" name="nama_penerima" value="{{ $data[0]->nama_penerima }}">
                                  </div>
                                  <div class="col-6">
                                    <label for="email_penerima" class="form-label">Email penerima</label>
                                    <input type="email" class="form-control" name="email_penerima" value="{{ $data[0]->email_penerima }}">
                                  </div>

                                  <div class="col-6">
                                    <label for="nomor_hp_penerima" class="form-label">Nomor HP penerima</label>
                                    <input type="telp" class="form-control" name="nomor_hp_penerima" value="{{ $data[0]->nomor_hp_penerima }}">
                                  </div>
                                  <div class="col-6">
                                      <label for="kode_pos_penerima" class="form-label">Kode Pos penerima</label>
                                      <input type="telp" class="form-control" name="kode_pos_penerima" value="{{ $data[0]->kode_pos_penerima }}">
                                  </div>
                                  <div class="col-12">
                                    <label for="alamat_penerima" class="form-label">Alamat penerima</label>
                                    <textarea class="form-control mb-2" style="height: 80px" name="alamat_penerima">{{ $data[0]->alamat_penerima }}</textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <label for="jumlah" class="form-label card-title me-5">Jenis Kerugian:</label>
                                  ...
                                  <div class="card card-body">
                                    <div class="row border">
                                      ...
                                      <div class="col-6 mb-3">
                                        ...
                                        @if ($data[0]->jenis_keterlambatan == 'SWP Senyatanya')
                                            {{ 'checked' }}
                                        @endif
                                        >
                                      ...
                                      <div class="col-6 mb-3">
                                        ...
                                        @if ($data[0]->jenis_keterlambatan == 'Standart SWP')
                                            {{ 'checked' }}
                                        @endif
                                        >
                                      ...
                                      <div class="col-6 mb-3">
                                        ...
                                        @if ($data[0]->jenis_keterlambatan == 'Hari Libur')
                                            {{ 'checked' }}
                                        @endif
                                        >
                                      ...
                                      <div class="col-6 mb-3">
                                        <input class="form-control" type="number" name="jenis_terlambat" id="jenis_terlambat4" placeholder="Jumlah terlambat" value="{{ $data[0]->jenis_keterlambatan }}">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-6">
                                        ...
                                        <select class="form-select form-select-sm" id="jumlah-kehilangan" name="jumlah_kehilangan">
                                          ...
                                          <option 
                                          @if ($data[0]->jumlah_kehilangan == 'Seluruh')
                                              {{ 'checked' }}
                                          @endif 
                                          value="Seluruh">Seluruh</option>
                                          <option
                                          @if ($data[0]->jumlah_kehilangan == 'Sebagian')
                                              {{ 'checked' }}
                                          @endif 
                                          value="Sebagian">Sebagiakn</option>>
                                        </select>
                                      </div>
                                      ...
                                      <div class="col-12 mb-3">
                                        ...
                                        <select class="form-select form-select-sm" id="jenis-kiriman" name="jenis-kiriman">
                                          ...
                                          @foreach ($jenisSurat as $js)
                                            <option value="{{ $js->jenis_surat }}"
                                              @if ($js->jenis_surat == $data[0]->jenis_kiriman )
                                                {{'selected'}}
                                              @endif
                                              >{{ $js->jenis_surat }}</option> 
                                          @endforeach
                                      ...
                                      <div class="col-12">
                                        ...
                                        <div class="row">
                                          <div class="col-12">
                                            <input class="form-check-input" type="radio" name="bukti_kehilangan" id="buktiKehilangan1" 
                                            @if ($data[0]->bukti_kehilangan == 'Dokumen Berita Acara')
                                              {{ 'checked' }}
                                            @endif
                                            value="Dokumen Berita Acara">
                                          ...
                                          <div class="col-12">
                                            <input class="form-check-input" type="radio" name="bukti_kehilangan" id="buktiKehilangan2"
                                            @if ($data[0]->bukti_kehilangan == 'Keputusan Direksi tentang jaminan ganti rugi kiriman surat dan paket')
                                              {{ 'checked' }}
                                            @endif
                                            value="Keputusan Direksi tentang jaminan ganti rugi kiriman surat dan paket">
                                ...
                                >
                                  <div class="card card-body">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="bukti_kerusakan" value="{{ $data[0]->bukti_kerusakan }}">
                                    <label for="tanggal_dokumen" class="form-label">Tanggal Dokumen</label>
                                    <input type="date" class="form-control form-control-sm" name="tanggal_dokumen" value="{{ $data[0]->tanggal_bukti }}">    
                                  </div>
                                </div>
                            </div>
                              ...
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  ...
                                  @foreach ($dataBarang as $db)
                                    <tr>
                                      <td scope="row" class="text-center">{{ $n }}</td>
                                      <td scope="row">{{ $db->isi_kiriman }}</td>
                                      <td scope="row">{{ "Rp " . number_format($db->biaya_kirim, 2, ",", ".") }}</td>
                                      <td scope="row">{{ "Rp " . number_format($db->nilai_barang , 2, ",", ".") }}</td>
                                    </tr>
                                    @php
                                        $n++;
                                    @endphp
                            ...
                            <div class="col-12">
                              <div class="row">
                                <div class="col-6">
                                  ...
                                  <input type="number" class="form-control form-control-sm" name="jumlah_ganti_rugi" value="{{ "Rp " . number_format($data[0]->jumlah_ganti_rugi, 2, ",", ".") }}">
                                </div>
  
                                <div class="col-6">
                                  <label for="rincian_gr1" class="form-label">Beban Perusahaan</label>
                                  <input type="number" class="form-control form-control-sm" name="rincian_gr1" value="{{ "Rp " . number_format($data[0]->beban_perusahaan, 2, ",", ".") }}">
                                </div>
  
                                <div class="col-6">
                                  <label for="rincian_gr2" class="form-label">Beban Pegawai</label>
                                  <input type="number" class="form-control form-control-sm" name="rincian_gr2" value="{{ "Rp " . number_format($data[0]->beban_pegawai, 2, ",", ".")}}">
                                </div>
  
                                <div class="col-6">
                                  <label for="rincian_gr3" class="form-label">Beban Mitra</label>
                                  <input type="number" class="form-control form-control-sm" name="rincian_gr3" value="{{  "Rp " . number_format($data[0]->beban_mitra, 2, ",", ".") }}">
                                </div>
                              </div>
                            </div>
                          </div>
